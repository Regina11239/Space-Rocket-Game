...
public class Grfx
{
   ...
   public static void setStar(Graphics g, Color rbg)
	{
	    g.setColor(rbg);
	    fillRectangle(g,0,0,4800,3600);
       Random random = new Random(23333);
       Random random2 = new Random(12345);       
		for (int k = 500; k <= 30000; k++)
		{
			int redRGB = random.nextInt(256);    	
		   int greenRGB = random.nextInt(256);
		   int blueRGB = random.nextInt(256);
         g.setColor(new Color(redRGB, greenRGB, blueRGB));
         int xValue = random.nextInt(4800);  	
			int yValue = random.nextInt(3600);
         g.drawLine(xValue,yValue,xValue,yValue+5);
      }
      
      for (int k = 0; k <= 1000; k++)
		{
			int redColorRGB = random2.nextInt(256);    	
		   int greenColorRGB = random2.nextInt(256);
		   int blueColorRGB = random2.nextInt(256);
         g.setColor(new Color(redColorRGB, greenColorRGB, blueColorRGB));
         int xC = random2.nextInt(4800);  	
			int yC = random2.nextInt(3600);
